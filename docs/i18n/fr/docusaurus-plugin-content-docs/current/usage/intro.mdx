...
Vous trouverez OpenHands fonctionnant à l'adresse [http://localhost:3333](http://localhost:3333) avec accès à `./workspace`. Pour qu'OpenHands fonctionne sur votre code, placez-le dans `./workspace`.
